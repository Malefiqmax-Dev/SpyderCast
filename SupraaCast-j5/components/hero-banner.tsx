      ...
      <div className="absolute bottom-0 left-0 right-0 px-4 pb-16 lg:px-8 lg:pb-24">
        <div className="max-w-2xl">
          ...
          <div className="mt-5 flex items-center gap-3">
            <Link
              href={detailUrl}
              className="flex items-center gap-2 rounded-lg bg-gradient-to-r from-amber-600 to-amber-700 px-5 py-2.5 text-sm font-semibold text-foreground transition-all hover:from-amber-500 hover:to-amber-600"
            >
